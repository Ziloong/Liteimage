...
- **本地引擎质量四档**：超低 / 低 / 中 / 高（默认），覆盖 10-95 质量范围
- **按长边等比缩放**：支持自定义像素数及快捷预设（1920 / 1280 / 800）
...
### v1.1（2026-04-22）
- **视频转 GIF**：统一 UI 界面，去掉子 Tab，拖放自动识别视频/GIF 文件
- **视频转 GIF**：导入视频后自动获取视频宽度和帧率作为默认值
- **图片压缩**：TinyPNG 覆盖源文件功能修复
- **图片压缩**：长边缩放改用 CoreGraphics 实现，支持缩小和放大
- **图片压缩**：拖放区文案去掉 GIF 支持提示
- **设置页**：新增飞书文档和 GitHub 仓库链接
